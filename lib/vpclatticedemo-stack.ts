...
import { AppServerStack } from "./appserver-stack";
import { LatticeStack } from "./lattice-stack";
...
export class VpclatticedemoStack extends cdk.Stack {
    ...
    private readonly _vpcLatticeStack: LatticeStack;
    ...
    constructor(scope: Construct, id: string, props?: VpclatticedemoStackProps & cdk.StackProps) {
        ...
        this._vpcLatticeStack = new LatticeStack(this, "VpcLattice", Object.assign(props!, {
            hostedZone: this._hostedZone,
            serviceAlb: this._appServerStack.alb,
            serviceName: "vpcLatticeDemo"
        }));
        this._vpcLatticeStack.addAlbService(this._appServerStack.alb, "appserver");

        this._vpcLatticeStack.createVpcAssociation(this._defaultVpc, "consumer-asscn");
    }
}      
